  ...
  <button className="bg-gray-800 hover:bg-gray-700 text-white font-semibold py-2 px-6 rounded-lg shadow-md transition-all">
    Add Services
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {["All", "Hair", "Styling", "Makeup", "Nail Art", "Facial"].map((category) => (
            <button key={category} className="px-4 py-2 bg-gray-200 rounded-full hover:bg-gray-300 transition text-sm">
              {category}
            </button>
          ))}
        </div>
